**都怪ppr,误导了我的思路，我会这么多方式，为什么非得用Python (bushi**
...
这个插件可以看作是[ppt-copier](https://github.com/huanhuan0812/ppt-copier)的改进版，从内部解决问题，大幅减少性能问题

**一定要看文件存储位置，以免第一次找不到配置文件**
...
- **Visual Studio Tools for Office Runtime**：需要安装 VSTO 运行时（setup.exe应该会自动下载并补全）
...
日志示例：
```
[2025-12-25 14:30:15] PowerPoint自动复制插件已启动
[2025-12-25 14:30:15] 日志保留天数: 7天，已清理过期日志
[2025-12-25 14:30:15] 加载状态文件成功，共 0 条记录
[2025-12-25 14:32:20] 检测到文档打开: E:\文档\演示文稿.pptx (打开方式: Normal)
[2025-12-25 14:32:20] 驱动器类型检测: E:\ - Removable, 是否可移动: True
[2025-12-25 14:32:20] 检测到移动存储设备文件，开始复制: E:\文档\演示文稿.pptx
[2025-12-25 14:32:21] 文件复制成功: E:\文档\演示文稿.pptx -> D:\Backup\2024-12-25\演示文稿.pptx
```
